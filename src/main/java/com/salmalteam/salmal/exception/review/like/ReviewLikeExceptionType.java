...
public enum ReviewLikeExceptionType implements ExceptionType {
    ...
    ReviewLikeExceptionType(final Status status, final int code, String clientMessage, String serverMessage){
        this.status = status;
        this.code = code;
