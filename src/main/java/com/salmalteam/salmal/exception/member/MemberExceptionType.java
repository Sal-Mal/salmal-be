...
public enum MemberExceptionType implements ExceptionType {
    ...
    DUPLICATED_NICKNAME(Status.BAD_REQUEST, 1005, "중복된 닉네임이 존재합니다.", "중복된 닉네임 요청"),
    INVALID_INTRODUCTION_LENGTH(Status.BAD_REQUEST, 1006, "소개글의 최대 길이는 30글자입니다.", "잘못된 길이의 소개글 요청")
    ;
